...
export default function FreeContent({ product, onComplete }: FreeContentProps) {
  ...
  if (hasAccessed) {
    return (
      <div className="text-center space-y-6 py-10 px-4 sm:px-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-slate-200 text-base leading-relaxed max-w-md mx-auto">
            Os links foram abertos em novas abas. Faça uma cópia para garantir o
            acesso e fique à vontade para fechar esta janela quando quiser.
          </p>
        </div>
        <Button
          onClick={onComplete}

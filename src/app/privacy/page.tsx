...
export default function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <section className="relative py-16 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <div className="bg-card rounded-xl p-8 md:p-12 shadow-sm border border-border space-y-8">
                <div>
                ...
                <div className="pt-8 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
                    ...
                    Proteção de Dados (LGPD) e regulamentações internacionais de
                    privacidade.
                  </p>
                </div>
              </div>

    ...
    <div className="rounded-b-2xl border-t border-white/10 bg-black/10 p-2 md:px-4 md:py-4 backdrop-blur-xl">
      <div className="mx-auto flex max-w-4xl items-center gap-3">
        <Input
          ...
          className="flex-1 border border-transparent bg-transparent  text-sm md:text-md lg:text-xl text-white placeholder:text-white/60 shadow-none focus:border-transparent focus:outline-none focus:shadow-none focus-visible:border-transparent focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:shadow-none"
          disabled={disabled}
        />
        <Button

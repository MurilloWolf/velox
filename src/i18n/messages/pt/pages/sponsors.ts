const sponsorsPage = {
  hero: {
    ...
    primaryCta: {
      ...
      ariaLabel: "Iniciar conversa com a equipe VELOX pelo WhatsApp",
      link: null,
    },
    secondaryCta: {
      label: "Receber media kit",
      ariaLabel: "Baixar o media kit da VELOX",
      link: null,
    },
    highlights: [
      {
  ...
  differentiatorsSection: {
    ...
    description:
      "Estamos construindo um público engajado e apaixonado por corrida. Veja alguns dos diferenciais que tornam nossa plataforma o ambiente ideal para sua marca se conectar com esse público.",
    cards: [
      {
        icon: "target",
        title: "Relevância",
      ...
      {
        icon: "trending-up",
        title: "Insights acionáveis desde o piloto",
        description:
  ...
  ctaCard: {
    ...
    description:
      "Agende uma conversa para entender públicos, calendário de corridas prioritárias e como transformar cada etapa em vantagem competitiva.",
    cta: {
      label: "Enviar mensagem",
      ariaLabel: "Abrir conversa com a equipe VELOX",
      link: null,
    },
  },
  contact: {
    whatsappNumber: "5518997708504",
    whatsappMessage: "Olá, gostaria de saber mais sobre o patrocínio da Velox.",
  },
  mediaKit: {
